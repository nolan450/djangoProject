...
urlpatterns = [
                  ...
                  path('programmes/planning', views.get_planning, name='programme_planning'),
                  path('programmes/add_programme_to_calendar', views.add_programme_to_calendar, name='add_programme_to_calendar'),
